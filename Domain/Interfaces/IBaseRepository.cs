...
public interface IBaseRepository<TEntity> where TEntity : class
{
    ...
    Task<Result<IEnumerable<TEntity>>> GetAllAsync(Expression<Func<IEnumerable<TEntity>, bool>>? expression = null, Func<IQueryable<TEntity>, IQueryable<TEntity>>? includes = null);
